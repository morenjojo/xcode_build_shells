...
#打包ipa
echo "****************archive****************"
xcodebuild -exportArchive -archivePath "${PRODUCT_PATH}/${APP_NAME}.xcarchive" -exportPath "${PRODUCT_PATH}/${IPANAME}" -exportOptionsPlist "${BASE_PATH}/inhouseArchiveOptions.plist"
